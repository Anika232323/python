...
if __name__ == "__main__":
 library = Library(name="Anika", email="anikamb@library.com")
 library.add_book(book_id="B007", title="Harry potter", author="J.K.Rowling")
 library.add_book(book_id="B005", title="1984 ", author="George Orwell")
 library.register_member(name="Shri", email="shri@example.com")
 library.register_member(name="Dev", email="dev@example.com")
 library.borrow_book(book_id="B008", member_id="LIB0243")
 library.return_book(book_id="B008")
